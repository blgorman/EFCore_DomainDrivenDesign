...
public static class DemonstrateReadOnlyCollections
{
    ...
    {
        //TODO: Module 2 Clip 5 — Delete the "Not Yet Implemented" box below.
        OutputHelpers.WriteColored(OutputHelpers.SectionBanner("Shadow Property — Order CustomerId"), ConsoleColor.DarkBlue);
        Console.Write(OutputHelpers.BoxedArrayWithTitle(
            "Not Yet Implemented",
            new[]
            {
                "This demo requires Clip 5 to be completed first:",
                "  Clip 5  — CustomerId removed from Order + shadow property + HasOne<Customer> config + migration",
                "",
                "When Clip 5 is complete:",
                "  Open DemonstrateReadOnlyCollections.cs",
                "  Find the TODO: Module 2 Clip 5 block below this NTI box",
                "  Uncomment the entire block"
            }
        ));

        //TODO: Module 2 Clip 5 — Uncomment ONLY after completing Clip 5 (CustomerId shadow property + HasOne<Customer> config + migration).
