...
public static class DemonstrateBackingFields
{
    public static async Task ShowBackingFieldConfigAsync(IServiceProvider serviceProvider)
    {
        ...
        Console.Write(OutputHelpers.BoxedArrayWithTitle(
            ...
            new[]
            {
                "This demo requires Clip 2 to be completed first:",
                "  Clip 2  — _lines backing field + IReadOnlyCollection<OrderLine> + HasField EF config",
                "",
                "When Clip 2 is complete:",
                "  Open DemonstrateBackingFields.cs",
                "  Find the TODO: Module 2 Clip 2 block below this NTI box",
                "  Uncomment the entire block"
            }
        ));

        //TODO: Module 2 Clip 2 — Uncomment ONLY after completing Clip 2 (backing field + IReadOnlyCollection + HasField).
        ...
        //
        ////TODO: Module 2 Clip 2 — OPTIONAL: Uncomment the block below to show the "What Doesn't Compile" explanation screen.
        ...
        //
        //// Save the new line and clear the change tracker so the query below materializes the order from the database.
        ...
        //));
        //
        //// Cleanup — remove the line this demo added so the database is left exactly as it was found.
        //ctx.Remove(order.Lines.OrderByDescending(l => l.Id).First());
        //await ctx.SaveChangesAsync();
