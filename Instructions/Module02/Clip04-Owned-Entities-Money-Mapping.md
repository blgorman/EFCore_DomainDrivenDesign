...
> ```
>
> For this clip, run this exact command from the solution root:
> ```powershell
> dotnet ef migrations add AddCurrencyToOrder --context OrderingContext --project OrderManagement.Infrastructure --startup-project ConsoleAppProject --output-dir Migrations/Ordering
> ```
>
> Then apply the migration to the database with this exact command from the solution root:
> ```powershell
> dotnet ef database update --context OrderingContext --project OrderManagement.Infrastructure --startup-project ConsoleAppProject
> ```
>
...
> ```
>
> For this clip, run this exact command:
> ```powershell
> Add-Migration AddCurrencyToOrder -Context OrderingContext -OutputDir Migrations/Ordering
> ```
>
> Then apply the migration to the database with this exact command:
> ```powershell
> Update-Database -Context OrderingContext
> ```
>
